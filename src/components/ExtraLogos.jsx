...
export const ExtraLogos = () => {
  ...
  return (
    <div className="relatve -mt-4 lg:col-span-7 lg:mt-0 xl:col-span-6">
     <p className="text-center text-sm font-semibold text-gray-900 lg:text-left">
      As Featured In
     </p>
     <ul 
     role="list"
     className="mx-auto mt-8 flex max-w-screen-xl flex-wrap justify-center gap-x-10 gap-y-8
     lg:mx-0 lg:justify-start">
     {
        logos.map(({title,logo})=>(
            <li>
            <Image src={logo} alt={title} className="h-8 w-full" unoptimized/>
            </li>
        ))
     }
     </ul>
